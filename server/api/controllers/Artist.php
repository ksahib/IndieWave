...
class Artist extends BaseController {
    ...
    public function _get() {
        ...
        try {
            ...
            $this->sendResponse(200, 'Retrieved Artist data', ['artist_name' => $artist["data"]["artist_name"], 'about' => $artist["data"]["about"], 'follower_count' => $artist["data"]["follower_count"], 'image_url' => $image["data"]["image_url"]]);
        }  catch(Exception $e)  {
